<template>
    <div class="flex flex-col">
        <div class="title-section justify-between">
            <div class="d-flex">
                <p><span class="text-first">Popular</span><span class="text-second"> Collections</span></p>
            </div>
        </div>
        <div class="search-section w-full">
            <div class="left-side w-auto float-left">

            </div>
            <div class="right-side w-96 float-right">
                <div class="mr-2">
                    <div class="bg-dark-blue lg:max-w-[384px] md:max-w-[720px] w-full shadow rounded mx-auto pb-10 px-6">
                        <div class="flex justify-start items-center py-7 relative">
                            ...
                            <svg class="absolute right-3 z-10 cursor-pointer" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path
                                    ...
                                    stroke="#4B5563" stroke-width="1.66667" stroke-linecap="round"
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div ref="searchTypeRef" class="hidden rounded w-full shadow border-t border-gray-200 px-1 py-2 absolute top-12 right-0 bg-white"
                        ...
                        <div class="mt-2">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="flex items-center border border-slate-300 px-4 py-3 rounded mt-2">
                                    <div class="svg-container" onclick="minusme_search(this)">
                                        <svg class="hover:bg-gray-100 cursor-pointer rounded-full" width="24"
